			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						school_course_manage.setClasses(Integer.parseInt(className));
						school_course_manage.setSubject_id(Integer.parseInt(subjectName));
						school_course_manage.setTeaching_start_time(startTime);
						school_course_manage.setTeaching_end_time(endTime);
						courseDao.add(school_course_manage);
						dispose();
